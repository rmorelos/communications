% File: bpsk_rayleigh_3branch_diversity
...
for m=1:size(snr,2)
    ...
    for n=1:N
        ...
        recMRC = 0;
        for i=1:3, recMRC = recMRC + a(i)*r(i);    end
        ...
        recEGC = 0;
        for i=1:3, recEGC = recEGC + r(i);    end
...
title('Performance of BPSK with three-branch diversity')
figure(2)
