...
% Modified Spring 2014 and 2015 for EE161. Modified in Spring 2023
...
set(gca,'YTick',[0 1]), grid on
title('Examples of line coding schemes - SJSU - EE161')
subplot(7,1,2)
plot(t,s_UNRZ,'k'); ylabel ('U-NRZ'); axis ([ 0 T_bits  -0.1*A 1.1*A ]), grid on
subplot(7,1,3)
plot(t,s_URZ,'k'); ylabel ('U-RZ'); axis ([ 0 T_bits  -0.1*A 1.1*A ]), grid on
subplot(7,1,4)
plot(t,AMI_RZ,'k'); ylabel ('AMI-RZ'); axis ([ 0 T_bits  -1.1*A 1.1*A ]), grid on
subplot(7,1,5)
plot(t,s_PNRZ,'k'); ylabel ('P-NRZ'); axis ([ 0 T_bits  -1.1*A 1.1*A ]), grid on
subplot(7,1,6)
plot(t,s_PRZ,'k'); ylabel ('P-RZ'); axis ([ 0 T_bits  -1.1*A 1.1*A ]), grid on
subplot(7,1,7)
