% File: pulse_shaping.m
% Description: Illustration of various mappings and pulse shapes (also 
% known as line coding) schemes
...
bit = [ 0 1 1 0 0 1 0 ];                % Bit sequence
...
set(gca,'YTick',[0 1])
grid on
title('Examples of mapping and pulse shaping (c)2012. EE160-SJSU-RHMZA')
subplot(5,1,2)
